...
public:
    ...
    void OnShortPressWithTimeout(std::function<void()> start_callback, std::function<void()> timeout_callback, uint16_t timeout_ms = 3000);

protected:
    gpio_num_t gpio_num_;
    button_handle_t button_handle_ = nullptr;
    esp_timer_handle_t timeout_timer_handle_ = nullptr;
    ...
    std::function<void()> on_short_press_start_;
    std::function<void()> on_short_press_timeout_;
};
