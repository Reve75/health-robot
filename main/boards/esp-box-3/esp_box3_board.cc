...
private:
    ...
    void InitializeButtons() {
        // Use the new short press with timeout functionality
        boot_button_.OnShortPressWithTimeout(
            // Start callback - called when button is released (short press detected)
            [this]() {
                ...
                // Start listening when button is released
                app.StartListening();
            },
            // Timeout callback - called after 3 seconds to stop listening
            [this]() {
                auto& app = Application::GetInstance();
                app.StopListening();
            },
