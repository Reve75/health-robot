...
public:
    ...
    virtual void SendStartListening(ListeningMode mode, bool medication_context = false);
    ...
    virtual void SendMedicationCleared();
    virtual void SendMedicationTaken(const std::string& medication_name);
    virtual void SendBloodPressure(int systolic, int diastolic, int pulse = 0);
    virtual void SendMedicationStatus(bool taken, const std::string& method = "manual");
    virtual void SendRequestMedication();
    virtual void SendReminderSent(const std::string& reminder_type);
    virtual void SendMedicationContext();
